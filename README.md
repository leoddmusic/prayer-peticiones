...
Este módulo permitirá registrar peticiones y actualizar su estado durante el seguimiento entre: **Pendiente**, **En seguimiento**, **Respondida** y **Cerrada**.
...
El repositorio incluye un flujo básico de CI con **GitHub Actions**. En este avance se comprueba que el pipeline se ejecuta correctamente; las pruebas automatizadas se incorporarán en avances posteriores.
